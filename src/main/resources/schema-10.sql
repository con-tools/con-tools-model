...
CREATE TABLE `purchases` (
  ...
  PRIMARY KEY (`id`) COMMENT '',
  FOREIGN KEY `fk_purchases_users_1` (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  FOREIGN KEY `fk_purchases_sales_1` (`sale_id`) REFERENCES `sales` (`id`) ON DELETE RESTRICT,
  FOREIGN KEY `fk_purchases_merchandise_1` (`sku_id`) REFERENCES `merchandise_skus` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
